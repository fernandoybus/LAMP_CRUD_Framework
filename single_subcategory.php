...
<h1>Showing all for Location <?php echo $_GET["subcategory"]; ?></h1>
...
$result = mysql_query("SELECT * FROM Posts WHERE SubCategory_ID = " . $subcategory_id);
